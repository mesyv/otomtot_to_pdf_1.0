...
def create_pdf():
    ...
    if not url:
        ...
        pdf.cell(WIDTH, 6, f"Cena: {car_price_final} EUR", border=bord, align="C", ln=True)
        ...
        print("PDF zapisany pomyślnie: " + os.getcwd() + "\\" + f"{brand}{model}_{year}.pdf")

get_eur()


root = tk.Tk()
root.title("Otomoto to PDF")
